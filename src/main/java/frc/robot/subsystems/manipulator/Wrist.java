...
public class Wrist 
{
    ...
    public Wrist(){
        ...
        var driveConfig = new SparkFlexConfig();    //TODO: invert the motor if needed to make positive motor speed increase the angle(go down) and negative motor speed decrease the angle (go up)
        driveConfig
